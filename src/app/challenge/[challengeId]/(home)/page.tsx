...
export default async function Category({ params }: { params: { challengeId: string } }) {
          ...
          <div className='space-y-4 py-4'>
            ...
            <article className='space-y-2 rounded-md border border-green-700 bg-green-700/5 p-4'>
              <p>
                ...
                repository and live application hosted on any platform. Additionally, please include a concise
                explanation of the work you have done.
              </p>
              <p>
